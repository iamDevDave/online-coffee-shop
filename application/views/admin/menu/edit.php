<div class="conatiner">
    <form id="myForm" action="<?php echo base_url().'admin/menu/edit/'.$item['i_id'];?>" method="POST"
        class="form-container mx-auto  shadow-container" style="width:80%" enctype="multipart/form-data">
        <h3 class="mb-3 text-center">Edit item "<?php echo $item['name']; ?>"</h3>
        <div class="form-group">
            <label class="control-label">Select Cafe</label>
            <select name="rname" id="resname"
                ...
                if (!empty($stores)) { 
                    foreach($stores as $store) {
                        ?>
                <option value="<?php echo $store['cafe_id'];?>">
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('name') != "") ? 'is-invalid' : '';?>" name="name" id="name"
                        placeholder="Enter item name" value="<?php echo set_value('name', $item['name']); ?>">
                    <span></span>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : '';?>" id="price" name="price"
                        placeholder="Enter Price" value="<?php echo set_value('price', $item['price']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="About" value="<?php echo set_value('about', $item['about']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php if($item['img'] != "" && file_exists('./public/uploads/items/'.$item['img'])) { ?>

                    <img src="<?php echo base_url().'./public/uploads/items/'.$item['img'];?>">
...
const validate = () => {
    ...
    if (resnameVal === "--Select cafes--") {
        setErrorMsg(resname, 'select cafes name');
    } else {
