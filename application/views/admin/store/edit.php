<div class="conatiner">
    <form action="<?php echo base_url().'admin/store/edit/'.$store['cafe_id'];?>" method="POST"
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <input type="text" name="caf_name"  class="form-control
                    <?php echo (form_error('caf_name') != "") ? 'is-invalid' : '';?>" placeholder="Add cafes name"
                        value="<?php echo set_value('caf_name', $store['name']);?>">
                    <?php echo form_error('caf_name'); ?>
                </div>
                <div class="form-group">
            ...
            <div class="col-md-12">
                <div class="form-group has-danger">
                    ...
                    <?php if($store['img'] != '' && file_exists('./public/uploads/cafes/'.$store['img'])) { ?>
                    <img class="mt-1" src="<?php echo base_url().'./public/uploads/cafes/'.$store['img']; ?>">
                    <?php } else {?>
