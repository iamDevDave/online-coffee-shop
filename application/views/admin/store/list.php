<div class="container my-3">
    <?php if($this->session->flashdata('caf_success') != ""):?>
    <div class="alert alert-success">
        <?php echo $this->session->flashdata('caf_success');?>
    </div>
    <?php endif ?>
            ...
            <table class="table table-striped table-responsive table-hover table-bordered">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo base_url().'admin/store/edit/'.$store['cafe_id']?>"
                                class="btn btn-info mb-1"><i class="fas fa-edit mr-1"></i>Edit</a>

                            <a href="javascript:void(0);" onclick="deleteStore(<?php echo $store['cafe_id']; ?>)"
