<div class="conatiner">
    <form action="<?php echo base_url().'admin/store/create_cafes';?>" method="POST"
        class="form-container mx-auto  shadow-container" id="myForm" style="width:90%" enctype="multipart/form-data">
        <h3 class="mb-3 p-2 text-center mb-3">Add New cafes Details</h3>
        <div class="row">
            <div class="col-md-6">
                <div class="form-group">
                    <label class="control-label">cafes Name</label>
                    <input type="text" name="caf_name" id="rname" class="form-control
                    <?php echo (form_error('caf_name') != "") ? 'is-invalid' : '';?>" placeholder="Add cafes Name"
                    value="<?php echo set_value('caf_name');?>">
