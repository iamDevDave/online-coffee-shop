    ...
    <div class="container my-3" style="border: 2px outset green;">
        ...
        <div class="invoice mb-3">
            <div class="row mb-3 p-3">
                <div class="col-6">
                    <h3 style="color:purple"><b>Online Coffee Shop</b></h3>
                </div>


                <div class="col-6">
                    <p class="lead font-weight-bold mb-0"><?php echo $caf['name'] ?></p>
                    <p class="mb-0"><?php echo $caf['email'] ?></p>
