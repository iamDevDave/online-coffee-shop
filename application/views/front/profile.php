...
<div class="row">
    <div class="col-md-6">
        <div class="wrapper mt-sm-5">
            ...
            <form action="<?php echo base_url().'profile/edit/'.$loggedUser['usecafe_id']?>" method="POST">
    ...
    <div class="col-md-6">
        <div class="wrapper mt-sm-5">
            ...
            <?php endif ?>
            <?php $loggedUser = $this->session->userdata('user');?>
            <form action="<?php echo base_url().'profile/editPassword/'.$loggedUser['usecafe_id']?>" method="POST">
