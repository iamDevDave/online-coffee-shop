...
class Store extends CI_Controller {
    ...
    public function create_cafes() {
        ...
        $config['upload_path']          = './public/uploads/cafes/';
        ...
        $this->form_validation->set_rules('caf_name', 'cafes name','trim|required');
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    $formArray['name'] = $this->input->post('caf_name');
                    ...
                    $this->session->set_flashdata('caf_success', 'cafes added successfully');
                    ...
                    $data['cats'] = $cat;
                    $this->load->view('admin/partials/header');
                    $this->load->view('admin/store/add_caf', $data);
                    $this->load->view('admin/partials/footer');
                }
        ...
        if($this->form_validation->run() == true) {
            ...
            if(!empty($_FILES['image']['name'])){
                ...
                if($this->upload->do_upload('image')) {
                    ...
                    if (file_exists('./public/uploads/cafes/'.$store['img'])) {
                        unlink('./public/uploads/cafes/'.$store['img']);
                    }
                    ...
                    $this->session->set_flashdata('caf_success', 'cafes updated successfully');
                    redirect(base_url(). 'admin/store/index');
    ...
    public function delete($id){
        ...
        if(empty($store)) {
            $this->session->set_flashdata('error', 'cafes not found');
        ...
        $this->session->set_flashdata('caf_success', 'Store deleted successfully');
        redirect(base_url().'admin/store/index');
